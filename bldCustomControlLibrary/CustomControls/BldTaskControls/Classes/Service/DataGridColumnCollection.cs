...
{
    /// <summary>
    ///     Internal class that holds theBldTaskDataGrid's column collection.  Handles error-checking columns as they come in.
    /// </summary>
    internal class DataGridColumnCollection : ObservableCollection<BldTaskDataGridColumn>
    {
       // internal BldTaskDataGridColumnCollection(BldTaskDataGrid dataGridOwner)
       // {
       //     Debug.Assert(dataGridOwner != null, "We should have a validBldTaskDataGrid");
       ...
       // protected override void InsertItem(int index, BldTaskDataGridColumn item)
       // {
       //     //if (item == null)
       //     //{
       ...
       //     item.CoerceValue(BldTaskDataGridColumn.IsFrozenProperty);
       // }

       // protected override void SetItem(int index, BldTaskDataGridColumn item)
       // {
       //     //if (item == null)
       //     //{
       //     //    //throw new ArgumentNullException("item", SR.Get(SRID.DataGrid_NullColumn));
       ...
       //     //           BldTaskDataGridOwner.UpdateColumnsOnVirtualizedCellInfoCollections(NotifyCollectionChangedAction.Reset, -1, null, -1);
       //     //        }
       ...
       //     // ClearBldTaskDataGrid reference is on all columns.
       //     // Doing it here since CollectionChanged notification wouldn't
       //     // propagate the cleared columns list.
       //   // BldTaskDataGridOwner.UpdateDataGridReference(this, true);
       //     base.ClearItems();
       // }
       ...
       // //internal void NotifyPropertyChanged(DependencyObject d, string propertyName, DependencyPropertyChangedEventArgs e,BldTaskDataGridNotificationTarget target)
       // //{
       // //    if (DataGridHelper.ShouldNotifyColumnCollection(target))
       // //    {
       // //        if (e.Property == BldTaskDataGridColumn.DisplayIndexProperty)
       // //        {
       // //            OnColumnDisplayIndexChanged((BldTaskDataGridColumn)d, (int)e.OldValue, (int)e.NewValue);
       // //            if (((BldTaskDataGridColumn)d).IsVisible)
       // //            {
       // //             //   InvalidateColumnRealization(true);
       // //            }
       // //        }
       // //        else if (e.Property == BldTaskDataGridColumn.WidthProperty)
       // //        {
       // //            if (((BldTaskDataGridColumn)d).IsVisible)
       // //            {
       ...
       // //            }
       // //        }
       // //       // else if (e.Property ==BldTaskDataGrid.FrozenColumnCountProperty)
       // //       // {
       // //       ////     InvalidateColumnRealization(false);
       // //       //     OnDataGridFrozenColumnCountChanged((int)e.OldValue, (int)e.NewValue);
       // //       // }
       // //       // else if (e.Property == BldTaskDataGridColumn.VisibilityProperty)
       // //       // {
       // //       //     InvalidateAverageColumnWidth();
       // //       //     InvalidateHasVisibleStarColumns();
       ...
       // //       //     InvalidateColumnRealization(true);
       // //       // }
       // //       // else if (e.Property ==BldTaskDataGrid.EnableColumnVirtualizationProperty)
       // //       // {
       // //       //     InvalidateColumnRealization(true);
       // //       // }
       // //       // else if (e.Property ==BldTaskDataGrid.CellsPanelHorizontalOffsetProperty)
       // //       // {
       // //       //     OnCellsPanelHorizontalOffsetChanged(e);
       // //       // }
       // //       // else if (e.Property ==BldTaskDataGrid.HorizontalScrollOffsetProperty ||
       ...
       // //            this[i].NotifyPropertyChanged(d, e,BldTaskDataGridNotificationTarget.Columns);
       // //        }
       // //    }
       // //}
       ...
       // /// <summary>
       // ///     Returns the BldTaskDataGridColumn with the given DisplayIndex
       // /// </summary>
       // //internal BldTaskDataGridColumn ColumnFromDisplayIndex(int displayIndex)
       // //{
       ...
       // //private int CoerceDefaultDisplayIndex(BldTaskDataGridColumn column)
       // //{
       ...
       // //private int CoerceDefaultDisplayIndex(BldTaskDataGridColumn column, int newDisplayIndex)
       // //{
       // //    if (DataGridHelper.IsDefaultValue(column, BldTaskDataGridColumn.DisplayIndexProperty))
       // //    {
       ...
       // //private void OnColumnDisplayIndexChanged(BldTaskDataGridColumn column, int oldDisplayIndex, int newDisplayIndex)
       // //{
       ...
       // //    {
       // //       BldTaskDataGridOwner.OnColumnDisplayIndexChanged(new BldTaskDataGridColumnEventArgs(column));
       // //    }
       ...
       // //       BldTaskDataGridOwner.UpdateColumnsOnVirtualizedCellInfoCollections(NotifyCollectionChangedAction.Move, oldDisplayIndex, null, newDisplayIndex);
       // //    }
       // //    finally
       // //    {
       ...
       // //   BldTaskDataGridOwner.UpdateColumnsOnVirtualizedCellInfoCollections(NotifyCollectionChangedAction.Move, oldColumnIndex, null, newColumnIndex);
       // //}
       ...
       // //        column = (BldTaskDataGridColumn)newColumns[0];
       ...
       // //       BldTaskDataGridOwner.UpdateColumnsOnVirtualizedCellInfoCollections(NotifyCollectionChangedAction.Add, -1, null, newDisplayIndex);
       // //    }
       // //    finally
       // //    {
       // //        IsUpdatingDisplayIndex = false;
       ...
       // //// This method is called in firstBldTaskDataGrid measure call
       ...
       // //private void InitializeDisplayIndexMap(BldTaskDataGridColumn changingColumn, int oldDisplayIndex, out int resultDisplayIndex)
       // //{
       ...
       // //    {
       // //        BldTaskDataGridColumn currentColumn = this[columnIndex];
       ...
       // //        BldTaskDataGridColumn currentColumn = this[columnIndex];
       // //        int currentColumnDisplayIndex = currentColumn.DisplayIndex;
       // //        bool hasDefaultDisplayIndex =BldTaskDataGridHelper.IsDefaultValue(currentColumn, BldTaskDataGridColumn.DisplayIndexProperty);
       // //        if (currentColumn == changingColumn)
       // //        {
       ...
       // //       BldTaskDataGridOwner.UpdateColumnsOnVirtualizedCellInfoCollections(NotifyCollectionChangedAction.Remove, removedDisplayIndex, (BldTaskDataGridColumn)oldColumns[0], -1);
       // //    }
       // //    finally
       // //    {
       // //        IsUpdatingDisplayIndex = false;
       ...
       // //        BldTaskDataGridColumn oldColumn = (BldTaskDataGridColumn)oldColumns[0];
       // //        BldTaskDataGridColumn newColumn = (BldTaskDataGridColumn)newColumns[0];
       ...
       // //           BldTaskDataGridOwner.UpdateColumnsOnVirtualizedCellInfoCollections(NotifyCollectionChangedAction.Replace, newDisplayIndex, oldColumn, newDisplayIndex);
       // //        }
       // //    }
       // //}
       ...
       // //            for (int i = 0; i < count; i++)
       // //            {
       // //                var column = (BldTaskDataGridColumn)oldColumns[i];
       ...
       // //                column.ClearValue(BldTaskDataGridColumn.DisplayIndexProperty);
       // //            }
       // //        }
       // //        finally
       // //        {
       ...
       // ///// </summary>
       // //private bool IsDisplayIndexValid(BldTaskDataGridColumn column, int displayIndex, bool isAdding)
       // //{
       // //    // -1 is legal only as a default value
       // //    if (displayIndex == -1 &&BldTaskDataGridHelper.IsDefaultValue(column, BldTaskDataGridColumn.DisplayIndexProperty))
       // //    {
       // //        return true;
       // //    }
       ...
       // ///// </summary>
       // //internal void ValidateDisplayIndex(BldTaskDataGridColumn column, int displayIndex)
       // //{
       ...
       // /////     Throws an ArgumentOutOfRangeException if the given displayIndex is invalid for the given column.
       // ///// </summary>
       // //internal void ValidateDisplayIndex(BldTaskDataGridColumn column, int displayIndex, bool isAdding)
       // //{
       ...
       // /// <summary>
       // ///     Method which sets / resets the IsFrozen property of columns based onBldTaskDataGrid's FrozenColumnCount.
       ...
       // //privateBldTaskDataGridBldTaskDataGridOwner
       // //{
       // //    get { return _dataGridOwner; }
       // //}

       // // Used by BldTaskDataGridColumnCollection to delay the validation of DisplayIndex
       ...
       // /// </summary>
       // private bool HasVisibleStarColumnsInternal(BldTaskDataGridColumn ignoredColumn, out double perStarWidth)
       // {
       //     bool hasStarColumns = false;
       //     perStarWidth = 0.0;
       //     foreach (BldTaskDataGridColumn column in this)
       //     {
       ...
       //        BldTaskDataGridLength width = column.Width;
       //         if (width.IsStar)
       //         {
       //             hasStarColumns = true;
       ...
       // /// </summary>
       // private bool HasVisibleStarColumnsInternal(BldTaskDataGridColumn ignoredColumn)
       // {
       //     double perStarWidth;
       ...
       //            BldTaskDataGridOwner.OnHasVisibleStarColumnsChanged();
       //         }
       //     }
       // }
       ...
       // {
       //     double totalDisplaySpace =BldTaskDataGridOwner.GetViewportWidthForColumns();
       ...
       //     List<BldTaskDataGridColumn> unResolvedColumns = new List<BldTaskDataGridColumn>();
       //     List<BldTaskDataGridColumn> partialResolvedColumns = new List<BldTaskDataGridColumn>();
       ...
       //         {
       //             BldTaskDataGridColumn column = unResolvedColumns[i];
       //            BldTaskDataGridLength width = column.Width;
       ...
       //             {
       //                 BldTaskDataGridColumn column = partialResolvedColumns[i];
       ...
       //     double totalAvailableWidth =BldTaskDataGridOwner.GetViewportWidthForColumns();
       ...
       //            BldTaskDataGridOwner.InternalItemsHost as VirtualizingStackPanel;
       //     if (vsp != null)
       //     {
       ...
       //    BldTaskDataGridOwner.Dispatcher.BeginInvoke(new DispatcherOperationCallback(ComputeColumnWidths), DispatcherPriority.Render, this);
       ...
       // {
       //     ComputeColumnWidths();
       //    BldTaskDataGridOwner.NotifyPropertyChanged(
       //        BldTaskDataGridOwner,
       //         "DelayedColumnWidthComputation",
       //         new DependencyPropertyChangedEventArgs(),
       //        BldTaskDataGridNotificationTarget.CellsPresenter |BldTaskDataGridNotificationTarget.ColumnHeadersPresenter);
       //     return null;
       // }
       ...
       //                 column.Width =BldTaskDataGridLength.Auto;
       //             }
       //         }
       ...
       //             double displayValue =BldTaskDataGridHelper.CoerceToMinMax(DoubleUtil.IsNaN(width.DesiredValue) ? minWidth : width.DesiredValue, minWidth, column.MaxWidth);
       //             if (!DoubleUtil.AreClose(width.DisplayValue, displayValue))
       //             {
       //                 column.SetWidthInternal(newBldTaskDataGridLength(width.Value, width.UnitType, width.DesiredValue, displayValue));
       //             }
       //         }
       //     }
       // }
       ...
       // /// </summary>
       // internal void RedistributeColumnWidthsOnMinWidthChangeOfColumn(BldTaskDataGridColumn changedColumn, double oldMinWidth)
       // {
       ...
       //    BldTaskDataGridLength width = changedColumn.Width;
       ...
       //         changedColumn.SetWidthInternal(newBldTaskDataGridLength(width.Value, width.UnitType, width.DesiredValue, minWidth));
       //     }
       ...
       //             changedColumn.SetWidthInternal(newBldTaskDataGridLength(width.Value, width.UnitType, width.DesiredValue, displayValue));
       //         }
       //     }
       // }
       ...
       // /// </summary>
       // internal void RedistributeColumnWidthsOnMaxWidthChangeOfColumn(BldTaskDataGridColumn changedColumn, double oldMaxWidth)
       // {
       //     if (ColumnWidthsComputationPending)
       //     {
       //         return;
       ...
       //         changedColumn.SetWidthInternal(newBldTaskDataGridLength(width.Value, width.UnitType, width.DesiredValue, maxWidth));
       //     }
       ...
       // /// </summary>
       // internal void RedistributeColumnWidthsOnWidthChangeOfColumn(BldTaskDataGridColumn changedColumn,BldTaskDataGridLength oldWidth)
       // {
       //     if (ColumnWidthsComputationPending)
       //     {
       //         return;
       ...
       //             changedColumn.SetWidthInternal(newBldTaskDataGridLength(width.Value, width.UnitType, width.DesiredValue, minWidth + leftOverSpace));
       //             RecomputeStarColumnWidths();
       //         }
       //     }
       //     else if (width.IsStar && oldWidth.IsStar)
       ...
       //         {
       //             column.SetWidthInternal(newBldTaskDataGridLength(width.Value, width.UnitType, width.DesiredValue, Math.Min(width.DesiredValue, maxWidth)));
       //         }
       //     }
       // }
       ...
       // /// </summary>
       // private void RedistributeColumnWidthsOnNonStarWidthChange(BldTaskDataGridColumn changedColumn,BldTaskDataGridLength oldWidth)
       // {
       //    BldTaskDataGridLength width = changedColumn.Width;
       ...
       //         {
       //             changedColumn.SetWidthInternal(newBldTaskDataGridLength(
       //                 width.Value,
       //                 width.UnitType,
       //                 width.DesiredValue,
       ...
       //     {
       //         double newDesiredValue =BldTaskDataGridHelper.CoerceToMinMax(width.DesiredValue, changedColumn.MinWidth, changedColumn.MaxWidth);
       ...
       // {
       //     _originalWidthsForResize = new Dictionary<BldTaskDataGridColumn,BldTaskDataGridLength>();
       //     foreach (BldTaskDataGridColumn column in this)
       //     {
       ...
       // /// </summary>
       // internal void RecomputeColumnWidthsOnColumnResize(BldTaskDataGridColumn resizingColumn, double horizontalChange, bool retainAuto)
       // {
       //    BldTaskDataGridLength resizingColumnWidth = resizingColumn.Width;
       ...
       //     else
       //     {
       //         BldTaskDataGridColumn column = ColumnFromDisplayIndex(resizingColumnIndex);
       ...
       // private static bool CanColumnParticipateInResize(BldTaskDataGridColumn column)
       // {
       ...
       //     {
       //         BldTaskDataGridColumn column = ColumnFromDisplayIndex(i);
       ...
       //                 column.SetWidthInternal(newBldTaskDataGridLength(width.Value, width.UnitType, width.DesiredValue, width.DisplayValue - columnExcessWidth));
       ...
       //         if (DoubleUtil.GreaterThan(horizontalChange, 0.0))
       //         {
       //             BldTaskDataGridColumn resizingColumn = ColumnFromDisplayIndex(resizingColumnIndex);
       ...
       //                 column.SetWidthInternal(newBldTaskDataGridLength(width.Value, width.UnitType, width.DesiredValue, width.DisplayValue + columnLagWidth));
       ...
       // /// </summary>
       // private static void SetResizedColumnWidth(BldTaskDataGridColumn column, double widthDelta, bool retainAuto)
       // {
       //    BldTaskDataGridLength width = column.Width;
       //     double columnDisplayWidth =BldTaskDataGridHelper.CoerceToMinMax(width.DisplayValue + widthDelta, column.MinWidth, column.MaxWidth);
       ...
       //     {
       //         column.SetWidthInternal(newBldTaskDataGridLength(width.Value, width.UnitType, width.DesiredValue, columnDisplayWidth));
       //     }
       //     else
       //     {
       //         column.SetWidthInternal(newBldTaskDataGridLength(columnDisplayWidth,BldTaskDataGridLengthUnitType.Pixel, columnDisplayWidth, columnDisplayWidth));
       //     }
       // }
       ...
       // private double GiveAwayWidthToColumns(BldTaskDataGridColumn ignoredColumn, double giveAwayWidth)
       // {
       ...
       // /// <param name="ignoredColumn">The column which is giving away the width</param>
       // /// <param name="giveAwayWidth">The amount of giveaway width</param>
       // private double GiveAwayWidthToColumns(BldTaskDataGridColumn ignoredColumn, double giveAwayWidth, bool recomputeStars)
       // {
       ...
       // /// </summary>
       // private double GiveAwayWidthToNonStarColumns(BldTaskDataGridColumn ignoredColumn, double giveAwayWidth)
       // {
       ...
       //     BldTaskDataGridColumn ignoredColumn,
       ...
       // /// </summary>
       // private void GiveAwayWidthToEveryNonStarColumn(BldTaskDataGridColumn ignoredColumn, double perColumnGiveAwayWidth)
       // {
       //     foreach (BldTaskDataGridColumn column in this)
       //     {
       //         if (ignoredColumn == column ||
       ...
       //         {
       //             column.SetWidthInternal(newBldTaskDataGridLength(width.Value, width.UnitType, width.DesiredValue, width.DisplayValue + perColumnGiveAwayWidth));
       //         }
       //     }
       // }
       ...
       // {
       //     double totalSpace =BldTaskDataGridOwner.GetViewportWidthForColumns();
       ...
       // /// </summary>
       // private double TakeAwayWidthFromColumns(BldTaskDataGridColumn ignoredColumn, double takeAwayWidth, bool widthAlreadyUtilized)
       // {
       //     double totalAvailableWidth =BldTaskDataGridOwner.GetViewportWidthForColumns();
       ...
       // ///     except the ignored column
       // /// </summary>
       // private double TakeAwayWidthFromColumns(BldTaskDataGridColumn ignoredColumn, double takeAwayWidth, bool widthAlreadyUtilized, double totalAvailableWidth)
       // {
       ...
       // ///     the star columns
       // /// </summary>
       // private double TakeAwayWidthFromStarColumns(BldTaskDataGridColumn ignoredColumn, double takeAwayWidth)
       // {
       ...
       // ///     among all non star columns except the ignored column
       // /// </summary>
       // private double TakeAwayWidthFromNonStarColumns(BldTaskDataGridColumn ignoredColumn, double takeAwayWidth)
       // {
       ...
       //         if (DoubleUtil.GreaterThan(width.DisplayValue, column.MinWidth))
       //         {
       //             column.SetWidthInternal(newBldTaskDataGridLength(width.Value, width.UnitType, width.DesiredValue, width.DisplayValue - perColumnTakeAwayWidth));
       //         }
       //     }
       // }
       ...
       //        BldTaskDataGrid dataGrid =BldTaskDataGridOwner;
       ...
       // privateBldTaskDataGrid _dataGridOwner;
