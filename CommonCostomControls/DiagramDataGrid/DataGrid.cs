...
namespace CommonCostomControls
{
    ...
    /// </summary>
    public class DataGrid : MultiSelector//, IAnimatable
    {
        #region Constructors
        ...
        int BringColumnIntoViewRetryCountField=0;
        ...
        public DataGridColumn ColumnFromDisplayIndex(int displayIndex)
        {
            if (displayIndex < 0 || displayIndex >= Columns.Count)
            {
               // throw new ArgumentOutOfRangeException("displayIndex", displayIndex, SR.Get(SRID.DataGrid_DisplayIndexOutOfRange));
                throw new ArgumentOutOfRangeException("displayIndex", displayIndex,@" ArgumentOutOfRangeException(displayIndex, displayIndex, SR.Get(SRID.DataGrid_DisplayIndexOutOfRange)");
            }
        ...
        internal bool IsCurrent(DataGridRow row, DataGridColumn column=null)
        {
            ...
            if (currentCell.ItemInfo == null)
            {
                ...
                // (Dev11 491052), by calling the implicit default ctor.  It's too late
