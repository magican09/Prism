...
{
    public class BldTaskDataGridTextColumn : BldTaskDataGridColumn
    {
        ...
        protected override FrameworkElement GenerateEditingElement(DataGridCell cell, object dataItem)
        {
            ...
            var _cell = cell as BldTaskDataGridCell;
            // DataGridHelper.RestoreFlowDirection(textBox, _cell);
            textBox.Text = cell.Column.Header.ToString();
            return textBox;
        }
        ...
        //                new FrameworkPropertyMetadata(SystemFonts.MessageFontFamily, FrameworkPropertyMetadataOptions.Inherits, BldTaskDataGridColumn.NotifyPropertyChangeForRefreshContent));
