...
{
    public class AddResponsibleEmployeeCommand : UnDoRedoCommandBase, IUnDoRedoCommand
    {
        ...
        public AddResponsibleEmployeeCommand(bldWork work, bldResponsibleEmployeesGroup bldResponsibleEmployees, bldResponsibleEmployee resp_empl)
        {
